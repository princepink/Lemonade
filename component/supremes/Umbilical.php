...
trait Umbilical {
    ...
    /**
     *  Elements which recommended having tabindex attribute
     */
    public static $form_controls = ['input','textarea','button','select'];
    ...
    /**
     *  Prefix string for a data URI of Base64-encoded SVG
     *  @since  ver. 0.11.1 (edit. Pierre, in Whip)
     *  @update ver. b-3.0.2 (edit. Angie)  renamed
     */
    ...
    /**
     *  Provides the data URI for Base64-encoded SVG
     *  @since  ver. 0.20.1 (edit. Hygeia)
     *  @update ver. b-3.0.2 (edit. Angie)  renamed and process fixed
     */
    public static function b64svgDataUri(string $svg_file): string
    {
